...
if (!isRender) { console.log('Modo local - inicializando WhatsApp...'); createClient(); } else { console.log('⏳ Modo Render - WhatsApp sob demanda via painel admin'); }
...
try { startServer(); } catch (err) { console.error('Erro crítico:', err); process.exit(1); }
